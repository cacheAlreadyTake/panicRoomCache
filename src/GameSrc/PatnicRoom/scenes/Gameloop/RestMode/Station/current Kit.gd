...
func setNewKiSsetSlotToMod(extra_arg_0: int) -> void:
	print(extra_arg_0)
	var cachedKitset = API_005_Player.currentChar._005_Common_Kitventory.getGearedKitSetByNr(extra_arg_0)
	API_005_Player.getCurrent_005_Common_Stationetter().setKitset(cachedKitset)

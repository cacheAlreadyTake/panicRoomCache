...
func manageCheckboxes(checkbox):
	match checkbox.grouping:
		"perk":
			API_005_Player.chargenSelecttion["perks"] = checkbox.toString
			clearBoxfield(allPerkCheckboxes)

		"kit":
			API_005_Player.chargenSelecttion["Kits"] = checkbox.toString
			clearBoxfield(allKitCheckboxes)
		"race":
			API_005_Player.chargenSelecttion["race"] = checkbox.toString

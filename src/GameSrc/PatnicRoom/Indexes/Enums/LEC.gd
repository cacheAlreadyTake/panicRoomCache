...
var TYPES_METADATA = {
	 "KITPART_BASE"     :  {   "CLASS" : BaseKitPartEntity , "MANDATORY" : ENUM.MINIMAL_COMP.KITPART_BASE   }
	,"KITPART_MOD"     :  {   "CLASS" : ModKitPartEntity  , "MANDATORY"  : ENUM.MINIMAL_COMP.KITPART_MOD    }

...
func initialice(kitPartEnum):
	...
	kitsetToModIndex    = API_005_Player.getCurrentStation().kitset.base.index()
...
func getListEntries():
	var allOwnedKitParts = API_005_Player.currentChar._005_Common_Kitventory._005_Common_Kitventory.listOfKits
	var arrToReturn = []
...
func selectListEntry(extra_arg_0: int) -> void:
	...
	API_005_Player.getCurrent_005_Common_Stationetter().setKitPartToMod(selectedKitPart)

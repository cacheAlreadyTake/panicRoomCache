...
func _ready() -> void:
	var allDomains = [ENUM.DIOJSONES.BASE_GAME_COMMUNITY_DATA_PATH,ENUM.DIOJSONES.BASE_GAME_PERSONAL_DATA_PATH]
	...
	for filepathBase in allDomains:
		...
		for element in allElements:
			...
			var scene = load("res://GameSrc/Universal/Scene/Bootstrap/GameInit/Submenues/content Manager/RowGameElement.tscn").instance()

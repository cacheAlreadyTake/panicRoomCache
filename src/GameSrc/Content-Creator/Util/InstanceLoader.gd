...
static func loadCompsOfForm(rootNode:Node2D,formToLoad:String):
	var form = Util.JSONParser.fileToDictionary("res://GameData/Alecandria/Forms/"+formToLoad)
...
static func loadLECsToBrowse(enumNr):
	...
	match enumNr:
		FORMS.VOID       : toLoad = {}
		FORMS.RACE       : toLoad = API_001_Atlas.RaceAtlas()
		FORMS.ROLE       : toLoad = API_001_Atlas.RoleAtlas()
		FORMS.SPECIALTY  : toLoad = API_001_Atlas.SpecialtyAtlas()
